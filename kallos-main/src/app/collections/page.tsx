      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-32">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-3xl border-b border-border pb-12 mb-14">
            <p className="text-[10px] tracking-[0.4em] text-kallos-crimson uppercase mb-4">Collections</p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {collections.map((collection) => (
              <Link
                ...
                className="group border border-border bg-card/70 px-6 py-8 transition-colors hover:border-kallos-crimson/40"
              >
                <p className="text-[10px] tracking-[0.3em] uppercase text-kallos-crimson mb-4">{collection.eyebrow}</p>
                ...
                <span className="text-[10px] tracking-[0.3em] uppercase text-muted-foreground group-hover:text-kallos-crimson transition-colors">
                  Explore collection
                </span>
              </Link>
            ))}
